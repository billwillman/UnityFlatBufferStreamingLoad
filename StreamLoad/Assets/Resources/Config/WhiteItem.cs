...
public struct WhiteItem : IFlatbufferObject
{
  ...
  public static Offset<Config.WhiteItem> CreateWhiteItem(FlatBufferBuilder builder,
      int index = 0,
      int pid = 0,
      int groupid = 0,
      int type = 0,
  ...
  public static Offset<Config.WhiteItem> EndWhiteItem(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Config.WhiteItem>(o);
  }
}
